...
$dataMonth = ArrayHelper::map(app\models\admin\Month::find()->all(), 'id', 'title_pl');
...
<?php Pjax::begin(['id' => 'payments_note']) ?>
    ...
    <?= $form->field($model, 'vacancy_name')->hiddenInput(['value'=>$model->vacancy_name])->label(false) ?>
    <?= $form->field($model, 'vacancy_name_pl')->hiddenInput(['value'=>$model->vacancy_name_pl])->label(false) ?>
<div class="col-md-3">
