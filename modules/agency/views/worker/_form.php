...
<div class="worker-form my-form">
  ...
  <?php $form = ActiveForm::begin([
    ...
    <?php if ($model->isNewRecord ){ ?>
      ...
      <a  data-toggle="popover" title="'.Yii::t('app', 'login_i').'" data-placement="top">
    ...
    ?>
      ...
      <div style="height: 0px;">
          <?= $form->field($users, 'type')->hiddenInput(['value'=> 3])->label(false) ?>
      ...
      ->hint('
      <div class="info-form-w">
      <a  data-toggle="popover" title="'.Yii::t('app', 'password_i').'" data-placement="top">
      <i class="fa fa-info-circle" style="font-size:25px"></i>
      </a></div>');
       ?>
      <div class="hr-line-dashed"></div>
