...
?>
<?php
$date = app\models\crm\VacancyWorker::find()->where(['vacancy_id' => $model->id])->all();
if (!empty($date)) {
  $worker = 'active';
  $vacancy ='';
}else{
...
<ul class="nav nav-tabs nav-justified">
  <li class="<?= $vacancy ?>"><a data-toggle="tab" href="#vacancy"><strong>Данные  по вакансии</strong></a></li>
  <?php if(!empty($date)) { ?>
  <li class="<?= $worker ?>"><a data-toggle="tab" href="#worker"><strong>Работники вакансии</strong></a></li>
  <?php } ?>
</ul>

<div class="tab-content">
  <div id="vacancy" class="tab-pane fade in <?= $vacancy ?>">
...
<hr>
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                  ...
                  'format'=>'ntext',
                  'visible' => !empty($model->ot_requirements),
                ],
                [
                  'attribute' => 'o_requirements_pl',
                  'visible' => !empty($model->o_requirements_pl),
                ],
                [
                  'attribute' => 'ot_requirements_pl',
                  'format'=>'ntext',
                  'visible' => !empty($model->ot_requirements_pl),
                ],
                [
                  'attribute' => 'hourinday',
                ...
                [
                  'attribute' => 'work_other_pl',
                  'format'=>'ntext',
                  'visible' => !empty($model->work_other_pl),
                ],
                [
                ...
                [
                  'attribute' => 'other_expenses_pl',
                  'format'=>'ntext',
                  'visible' => !empty($model->other_expenses_pl),
                ],
                [
          				'attribute' => 'turn_to',
                  'value'=>function($model){
  ...
  <div id="worker" class="tab-pane fade in <?= $worker ?>">
  <?php if(!empty($date)) { ?>
      <hr>
