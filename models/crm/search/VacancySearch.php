...
class VacancySearch extends Vacancy
{
    ...
    {
        $query = Vacancy::find()->orderBy(['work_status' => SORT_ASC]);
        ...
        $query->andFilterWhere([
            ...
            'agreed'=> $this->agreed,
            'status'=> $this->status,
            'driver_licensev'=> $this->driver_license,
        ]);
